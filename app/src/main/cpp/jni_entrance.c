...
JNIEXPORT jstring JNICALL Java_com_zcc_soundbat_Utils_fftw_1init(
...
JNIEXPORT jstring JNICALL Java_com_zcc_soundbat_Utils_fftw_1dft_12d(
		JNIEnv * env, jobject thiz) {
...
JNIEXPORT jstring JNICALL Java_com_zcc_soundbat_Utils_fftw_1dft_1r2c_12d(
		JNIEnv * env, jobject thiz) {
	double t_start, t_end, t_span;
	t_start = now_ms();
...
JNIEXPORT jstring JNICALL Java_com_zcc_soundbat_Utils_fftwf_1dft_1r2c_12d(
		JNIEnv * env, jobject thiz) {
	double t_start, t_end, t_span;
	t_start = now_ms();
...
JNIEXPORT jstring JNICALL Java_com_zcc_soundbat_Utils_fftwf_1dft_1r2c_12d_1thread(
		JNIEnv * env, jobject thiz) {
	double t_start, t_end, t_span;
	t_start = now_ms();
...
JNIEXPORT jstring JNICALL Java_com_zcc_soundbat_Utils_fftwf_1dft_1r2c_12d_1thread_1measure(
		JNIEnv * env, jobject thiz) {
